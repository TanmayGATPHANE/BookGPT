  ...
  return (
    <div className="min-h-screen bg-gradient-bg flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {/* Floating Book Icons */}
        <div className="absolute top-20 left-20 animate-float-slow opacity-10">
        ...
        <div className="absolute bottom-32 right-16 animate-float-delayed opacity-15">
          <svg className="w-12 h-12 text-orange-400" fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
          </svg>
        </div>
        <div className="absolute top-1/3 right-1/4 animate-float-reverse opacity-8">
        ...
        <div className="absolute inset-0">
          {[...Array(8)].map((_, i) => (
            <div
              key={i}
              className="absolute w-1 h-1 bg-orange-200 rounded-full animate-particle-float opacity-20"
              style={{
      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-4">
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-8 animate-fade-in-up">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome to BookGPT</h1>
